...
LEMMAS_TFIDF = 'tf-idf/lemmas'
LEMMAS_TFIDF_PATH = f'{LEMMAS_TFIDF}/'
LEMMA_TOKENS_FILE = 'lemma_1.txt'
...
def process_query(query: str):
    ...
    results = {doc: multiply_vectors(lemmas, doc_to_lemma[str(doc) + '.txt'], doc_lengths[str(doc) + '.txt']) for doc in doc_set}
